...
const schema = yup
  .object({
    fullName: yup
      ...
      .min(3, "Your full name should be at least 3 characters long."),
    subject: yup
      .string()
      .required("Please enter your subject")
      .min(3, "Your subject is too short"),
    email: yup
      .string()
    ...
    yourMessage: yup
      .string()
      .required("How may we assist you?")
        ...
        >
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1 p-2 bg-slate-300 rounded-xl">
              ...
              <input
                className="rounded-xl ps-2 h-8"
                name="full-name"
                placeholder="Your full name"
                {...register("fullName")}
              />
              <div className="flex flex-shrink">
                <p className="bg-white text-red-600 font-bold px-2 uppercase">
            ...
            <div className="flex flex-col gap-1 p-2 bg-slate-300 rounded-xl">
              ...
              <textarea
                className="rounded-xl ps-2 h-28"
                name="body"
                placeholder="Your email address"
          ...
          <div>
            <input
              type="submit"
              className="bg-orange-600 text-white p-4 font-bold uppercase rounded-xl hover:bg-orange-700 shadow-xl"
            />
          </div>
        </form>
      </fieldset>
